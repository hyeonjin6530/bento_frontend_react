        ...
        bioSignal.map((signal, i) => (
          <div key={i}>
            <div className="bio-signal-row">
              <span className="text-sm"><strong>Date:</strong> {signal.concept_name}</span>
              <span className="divider">|</span>
              <span className="text-sm"><strong>Concept ID:</strong> {signal.bio_signal_concept_id}</span>
              <span className="divider">|</span>
              <span className="text-sm"><strong>Source Value:</strong> {signal.bio_signal_source_value}</span>
            </div>
