...
export default function SearchField({
  ...
  // API: 문자열별 데이터 건수 확인
  const checkKeywordCount = useCallback(
    async (keywordItem) => {
      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="mb-3 flex items-center gap-2">
            <label className="text-m block font-medium text-gray-800">
              문자열 추가
            </label>
            <div className="group relative">
              <span className="cursor-pointer text-sm text-gray-400">ⓘ</span>
              <div className="pointer-events-none absolute left-full top-1/2 z-[9999] ml-2 w-80 -translate-y-1/2 rounded-lg border border-gray-600 bg-gray-800 px-2.5 py-0.5 text-xs font-extralight text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
                <div className="relative">
                  현재 설정창에서 문자열은 1개만 추가할 수 있습니다. <br />
                  더 많은 문자열을 추가하려면 현재 설정창을 닫고, <br />
                  필드를 컨테이너에 드래그한 후 새로운 설정창을 열어
                  추가해주세요.
                </div>
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 rounded-md bg-blue-600 px-4 py-2 text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-gray-400"
              >
                {selectedKeyword ? (
                  <>
                    <svg
          ...
          <div className="flex items-center justify-between rounded-md border border-blue-200 bg-blue-50 p-3">
            <div className="flex-1">
              <div className="mb-1 flex items-center gap-2">
                ...
                <span className="rounded-xl border border-gray-400 px-1.5 py-0.5 text-xs text-gray-600">
